...
module.exports.create = function(port, log) {
    ...
    console.log(" -- Enter Function: pserver/create");
    ...
    var createPeer = function(port, host) {

        console.log(" -- Enter Function: pserver/createPeer");
                ...
                rpcClient.call(
                  {
                    ...
                    "id"      : randstr.generate(),
                      ...
                      if (err) {
                        console.log(helper.getTimestamp()+"Error here!");
                      } else{
                        console.log(helper.getTimestamp()+"No error!");
                      }
        ...
        console.log(" -- Exit Function: pserver/createPeer");
    }
    ...
    rpcServer.addMethod('setup', function(req, res) {
        log("received SETUP");
    ...
    rpcServer.addMethod('drop', function(req, res) {
    ...
    rpcServer.addMethod('store', function(req, res) {
        var data = req.body;
        var name = data.name;
    ...
    rpcServer.addMethod('fetch', function(req, res) {
        var data = req.body;
        var name = data.name;
    ...
    rpcServer.addMethod('propose', dropPacket, function(req, res) {
        var data = req.body;
        var name = data.name;
        var instance = data.instance;
    ...
    rpcServer.addMethod('accept', dropPacket, function(req, res) {
        var data = req.body;
        var name = data.name;
        var instance = data.instance;
        var proposal = data.proposal;
    ...
    rpcServer.addMethod('learn', dropPacket, function(req, res) {
        var data = req.body;
        var name = data.name;
        var instance = data.instance;
        var value = data.value;
    ...
    console.log(" -- Exit Function: pserver/create");
}
